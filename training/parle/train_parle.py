"""
=============================================================
Train Parle-G Biscuit Detector — YOLOv8m
=============================================================
Usage:
    python training/parle/train_parle.py
"""
...
DATASET_ZIP   = PROJECT_ROOT / "dataset_zips" / "parle.v1i.yolov8.zip"
DATASET_DIR   = PROJECT_ROOT / "training" / "parle" / "dataset"
RUNS_DIR      = PROJECT_ROOT / "training" / "parle" / "runs"
...
def train():
    ...
    print("[INFO] Starting Parle-G YOLOv8m training ...\n")

    model = YOLO("yolov8m.pt")

    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_name  = f"parle_{timestamp}"
    ...
    best_dst = MODELS_DIR / "parle_best.pt"
    if best_src.exists():
