"""
=============================================================
Train Monaco Biscuit Detector — YOLOv8m
=============================================================
Usage:
    python training/monaco/train_monaco.py
"""
...
DATASET_ZIP   = PROJECT_ROOT / "dataset_zips" / "Monaco.v10i.yolov8.zip"
DATASET_DIR   = PROJECT_ROOT / "training" / "monaco" / "dataset"
RUNS_DIR      = PROJECT_ROOT / "training" / "monaco" / "runs"
...
def prepare_dataset():
    """Unzip dataset and fix paths in data.yaml."""
...
def train():
    ...
    print("[INFO] Starting Monaco YOLOv8m training ...\n")

    model = YOLO("yolov8m.pt")          # pretrained backbone

    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_name  = f"monaco_{timestamp}"
    ...
    best_dst = MODELS_DIR / "monaco_best.pt"
    if best_src.exists():
